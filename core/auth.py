        ...
        if not await client.is_user_authorized():
            ...
            try:
                ...
                if not await client.is_user_authorized():
                    ...
                    return None
                logger.success("Login successful. User is now authorized.")
                ...
                try:
                    ...
                    if not await client.is_user_authorized():
                        ...
                        await client.disconnect()
                        return None
                    logger.success("2FA login successful. User authorized.")
            ...
            if me:
                ...
                logger.success(
                    f"User already authorized. Connected as: {me.username or me.first_name or me.id}"
                )
            else:
